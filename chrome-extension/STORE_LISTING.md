...
- Capturas preparadas: `store-screenshot-popup.png` e `store-screenshot-sidepanel.png` (composição horizontal 1280×800, usando as interfaces reais do popup e do painel lateral; revisar o enquadramento no painel da loja antes do envio).
