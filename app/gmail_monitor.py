            ...
            for index, raw_text in enumerate(blocks, start=1):
                try:
                    ...
                    captured_data = {
                        ...
                        "contract_type": parsed_job.get("contract_type"),
                        "modality_confidence": parsed_job.get("modality_confidence"),
                        "salary_confidence": parsed_job.get("salary_confidence"),
                        "contract_confidence": parsed_job.get("contract_confidence"),
