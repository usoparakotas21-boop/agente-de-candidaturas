(function(){
  ...
  const configureMfa=async()=>{
    ...
    try{
      ...
      if(result.reauth_required){alert('Autenticador ativado. Entre novamente e confirme o código para concluir a proteção da sessão.');location.href='/dashboard';}
    }catch(error){
