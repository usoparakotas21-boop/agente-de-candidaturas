(() => {
  ...
  card.innerHTML = `
    ...
    <p>Conecte o complemento para preparar campos vazios da sua candidatura na Gupy, Vagas.com e InfoJobs. Seu perfil é buscado somente depois da autorização.</p>
    ...
    <div class="actions cc-assistant-actions">
      <a class="secondary" href="/static/candidatura-certa-autopreenchimento.zip?v=6" download>Baixar complemento para Chrome/Edge</a>
    </div>
    <details>
