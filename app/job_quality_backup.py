...
def split_job_alert(subject: str, content: str) -> list[str]:
    ...
    if len(url_indexes) > 1:
        ...
        for position, url_index in enumerate(url_indexes):
            ...
            if title_positions:
                # Remove cabecalhos e navegacao que antecedem o cartao da vaga.
...
def assess_job_capture(parsed: dict[str, Any]) -> dict[str, Any]:
    ...
    if title_score < 40 or description_score < 35 or confidence < 45:
        decision = "DESCARTAR"
