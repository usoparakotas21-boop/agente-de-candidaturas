...
def _page(path: Path) -> HTMLResponse:
    ...
    nav += '<style>button,.button,.btn,.refresh,.new-job,.action-button,.queue-action{font-family:inherit}select{min-height:42px;border-radius:10px}.status-success{color:#16794b;background:#eaf8f1}.status-warning{color:#a15c00;background:#fff5df}.status-neutral{color:#596579;background:#eef1f5}.status-danger{color:#b42318;background:#fff0ee}</style>'
    if path.name == "dashboard.html":
        nav = '<style>#newJobButton{display:none!important}.hero-actions{gap:12px}.hero-actions .refresh{font-size:13px;color:#36516e;background:#fff}.hero-actions .new-job{font-size:14px;min-height:44px;padding:12px 20px}.metric{position:relative;overflow:hidden}.metric::before{display:block;font-size:22px;margin-bottom:8px}.metric:nth-child(1)::before{content:"◈";color:#2f6fed}.metric:nth-child(2)::before{content:"✓";color:#16804f}.metric:nth-child(3)::before{content:"!";color:#b7791f}.metric:nth-child(4)::before{content:"×";color:#b42318}.metric:nth-child(2){border-top:3px solid #55b985}.metric:nth-child(3){border-top:3px solid #e7b84b}.metric:nth-child(4){border-top:3px solid #e38a82}</style>'
