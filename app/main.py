...
app = FastAPI(title="AgenteDeCandidaturas", version="0.24.0")
...
def root():
    if not LANDING_PATH.is_file():
        return {"agente": "AgenteDeCandidaturas", "status": "online", "version": "0.24.0", "dashboard": "/dashboard"}
