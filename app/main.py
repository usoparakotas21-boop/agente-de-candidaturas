...
def _page(path: Path) -> HTMLResponse:
    ...
    html = html.replace("</body>", '<script src="/static/support-chat.js?v=2" defer></script></body>', 1)
...
def root():
    ...
    rendered = html.replace(
        ...
        + f'<script src="/static/modal-a11y.js"></script><script src="/static/landing-enhance.js"></script><script nonce="{nonce}">' + auth_script + '</script><script src="/static/support-chat.js?v=2" defer></script></body>',
        1,
    )
    return HTMLResponse(rendered)
