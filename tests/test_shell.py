...
class ShellLayoutTest(unittest.TestCase):
    ...
    def test_applications_page_surfaces_retry_on_load_failure(self):
        ...
        self.assertIn('id="toggleKanban"', html)
        self.assertIn('id="kanban"', html)
        self.assertIn("moveKanbanCard", html)
    ...
    def test_document_studio_shows_generation_progress(self):
        ...
        self.assertIn("candidatura-certa.pending-export", html)
        self.assertIn("savePendingExport(current.application_id)", html)
        self.assertIn("readPendingExport()", html)
        self.assertIn("Retomamos a candidatura que aguardava confirmação do pagamento.", html)
        self.assertIn("restorePendingCheckoutOnFocus", html)
        self.assertIn("visibilitychange", html)
        self.assertIn("Verificamos novamente o pagamento e a geração dos documentos.", html)
