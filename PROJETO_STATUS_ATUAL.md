...
| Feedback assíncrono de OCR e validação de arquivos | Mensagens específicas, região de status acessível, skeleton do drawer, skeleton/retry do Banco de vagas e recuperação explícita em currículo, preferências, candidaturas e entrevistas existem; resta apenas revisar estados de ciclo de vida e cópia final | **100%** | **Concluído em P1.17** |
