...
17. **UX de primeiro acesso e polimento final — primeira entrega publicada:** o dashboard agora oferece um tour guiado dispensável em três passos, com estado persistido no navegador e ações para currículos, preferências e captação. Ainda faltam a revisão da hierarquia dos dados extraídos por OCR, estados de progresso mais completos, microinterações gerais e a revisão final das mensagens de recuperação.
