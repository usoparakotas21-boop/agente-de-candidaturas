...
| P1.22 | Candidatura automática por canal autorizado | **15% (estimativa; mudanças locais)** | Perfil, análise, currículo/carta direcionados e histórico já existem. O fluxo de Vagas agora dispara a preparação dos documentos em um clique; ainda não há integração de envio ou autorização de candidatura em nenhum portal. A submissão automática exige API/convênio permitido por plataforma; extensão/bot não será usado onde os termos o proíbem. |
