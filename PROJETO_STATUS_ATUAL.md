...
**Commit publicado:** `b247479` — `docs: record production verification of latest cycle`
...
- A prévia de intake classifica CLT, PJ, MEI, estágio, temporário e freelance e informa confiança para modalidade, salário e regime; esses campos agora persistem na fila, na vaga promovida e nas respostas de vagas/exportação. Continua pendente separar salário oferecido de pretensão do candidato.
