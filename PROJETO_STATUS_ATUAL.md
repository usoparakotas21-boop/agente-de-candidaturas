...
- A configuração de senha do Supabase foi reforçada com o requisito de letras maiúsculas/minúsculas, números e símbolos; o mínimo de 10 caracteres continua garantido pelo backend da aplicação. A proteção nativa contra senhas vazadas segue indisponível no plano atual e permanece em **P0.10**.
