...
**Commit publicado:** `6d19109` — `feat: persist structured salary bounds`
...
- A comparação salarial passou a usar limites estruturados da vaga quando disponíveis, com fallback para texto legado; a suíte completa ficou em **117 testes aprovados em 5,21 s**, com 6 avisos de depreciação sem falhas.
