...
| P1 | Consultoria recorrente | **90% implementação** | Checkout de R$ 197/mês, webhook idempotente, crédito de 1 atendimento por ciclo pago, solicitação de horário e cancelamento implementados. Falta publicar e fazer uma compra controlada em produção, sem considerar concluída a etapa operacional de atendimento até a primeira sessão ser entregue. |
