...
- **P1.20 — gate de fonte preparado:** `SOURCE_GOVERNANCE.md` registra a avaliação inicial de Lever, Greenhouse e Gupy; `app/source_governance.py` exige aprovação, evidências, direitos de uso, endpoint exato, limites e revisão a cada 180 dias. O registro global está vazio e não aprova nenhum ATS por fama ou disponibilidade pública. Os 13 testes direcionados passaram; a coleta automática continua desativada até uma autorização específica.
