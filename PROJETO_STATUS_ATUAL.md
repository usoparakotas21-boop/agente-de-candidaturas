...
| Favicon e identidade visual na aba do navegador | As páginas não declaram um `rel="icon"` próprio; o navegador exibe o ícone genérico da aplicação/framework | **0%** | **P1.17**, junto do polimento visual final; criar um favicon SVG/PNG `AC` e referenciá-lo no shell público e autenticado |
