...
**Commit de aplicação mais recente:** atualização operacional será registrada após o deploy desta rodada.
...
| Entrega paga e histórico de documentos | Checkout de retorno gera e persiste os dois DOCX, cria biblioteca owner-scoped, downloads protegidos, e-mail confirmado com outbox/retry e retenção. Código publicado após esta rodada; falta SMTP de produção e teste real | **85%** | **P1.10 — concluir ao configurar SMTP** |
