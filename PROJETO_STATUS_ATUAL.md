...
| P1.11 | Fechamento dos textos legais | **80% (estimativa)** | Páginas públicas, consentimento versionado e contatos oficiais já estão no site; ainda faltam controlador, retenção e subprocessadores. |
